...
namespace Service
{
    public sealed class ServiceManager : IServiceManager
    {
            ...
            )
        {
            ...
            _authenticationService = new Lazy<IAuthenticationService>(() => new AuthenticationService(logger, mapper, userManager, configuration, roleManager, repositoryManager, memoryCache));
