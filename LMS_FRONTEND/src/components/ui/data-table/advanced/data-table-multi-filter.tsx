...
interface MultiFilterRowProps<TData> {
  ...
  setOperator: React.Dispatch<React.SetStateAction<DataTableConfig['logicalOperators'][number]>>;
}
    ...
    <div className='flex items-center space-x-2'>
      {i === 0 ? (
        ...
        <Select
          ...
          onValueChange={(value) => {
            const operator = dataTableConfig.logicalOperators.find((o) => o.value === value);
            if (operator) {
