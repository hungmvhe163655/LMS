    ...
    return (
      <>
        {flattenChildren.map((child, index) => {
          ...
          const childRef = isObserveTarget ? observerRef : ref;

          // Using type assertion to handle cases where child might not accept ref
          return React.cloneElement(child as React.ReactElement<any> & { ref?: React.Ref<any> }, {
            ref: childRef
          });
        })}
      </>
